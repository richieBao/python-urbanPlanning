...
<img src="https://github.com/richieBao/python-urbanPlanning/blob/master/images/26_30.png" width="400" align="right">

这个预测的实验时可以再进一步拓展，需要解决几个问题，例如解释变量的调整，最好含有能够反映地表覆盖结构的指数，根据已有研究，植被分布结构的不同会影像地表温度的变化；以及，温度预测分布层级的细化，当前为依据温度均值划分的二分类，可以再进一步细化，获得更为准确的分布预测。
