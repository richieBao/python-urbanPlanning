...
计算建成区的连接度，最小距离卷积核计算结果呈现出最大关联的区域，也是绿地率相对较小的区域。从图10结果分析，从芝加哥市中心向外延申为连续的建成区域，以W Garfield Blvd和CSXT运输铁路为界，主要集中与其北区和西部。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTExOTE5MzIyNiw5NzYwNDA2ODksLTEzND
