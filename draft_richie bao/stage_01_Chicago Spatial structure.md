...
250m是基于城市生活数据城市边缘区域的界定距离，是人们实际主要活动的区域。内部的空白区域主要为具有一定规模的公园绿地， 以及大部分的居住区域。因为所选择的数据包含公路设施标签，因此可以明显观察到在居住区域
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk2NjQxMTM0OCwtNjcyNzczNjUyLC0xNz
