...
250m(Fig 8)is the defined distance of the urban fringe based on the data of urban life, which is the actual main acitivity area of people. The blank area inside is mainly the park green space with a certain scale, and most of

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzOTk2OTcxMCwtNjcyNzczNjUyLC0xNz
