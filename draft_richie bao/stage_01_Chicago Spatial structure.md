...
计算建成区的连接度，最小距离卷积核计算结果呈现出最大关联的区域，也是绿地率相对较小的区域。从图10结果分析，从芝加哥市中心向外延申为连续的建成区域，以W Garfield Blvd和CSXT运输铁路为界，主要集中于其北部和西部，是面积最大的连续建成区。同时机场# O'Hare International Airport和
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NDYzODc3ODAsOTc2MDQwNjg5LC0xMz
