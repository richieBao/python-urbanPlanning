...
图2中30m层级的聚类结果中，最大的聚类区域已经基本提取了芝加哥城的主要区域，并纳入了部分临近的区域，主要包括Elk Grove Village, Northlack, Melrose Park, 。同时沿城市主要道路延申。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDA3NzIzMTUsLTI3NDIwODM0LDcyND
