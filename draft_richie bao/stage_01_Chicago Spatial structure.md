...
The line curves and inflection points between the maximum total number of clustering, the frequency of indepenent points and the clustering distance were calculated respectively, and the box graph of the clustering freqency was also established to obtain the distance of the critical levels of 140 
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzU0ODE1NjEzLDU1MjI0NzAzOCwyNzA2Nj
