...
The line curves and inflection points between the maximum total number of clustering, the frequency of indepenent points and the clustering distance were calculated respectively(Fig 6, 7), and the box graph ()of the clustering freqency was also established to obtain the distance of the critical levels of 140m,190m,160m and 250m.  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTExNzEyOTAwNiw1NTIyNDcwMzgsMjcwNj
