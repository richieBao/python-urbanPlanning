...
聚类总数随着聚类距离的增加而降低（图5），在180m拐点之前降低的速度较之之后快。该拐点说明了城市建成区在扩张过程中，在该距离之下达到相对稳定的一个状态。自然因素在该过程中起到主要的作用，从图6中可以观察到，建成区基本位于海拔200m及其以下的区域，而早期的大部分建筑就建在芝加哥河口附近的低矮沙丘上。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQ2NzI2MzY1LC0xOTY0NTk3ODMwLDIzMD
