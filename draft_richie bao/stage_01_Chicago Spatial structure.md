...
城市生活行为是受到距离的影响，在不同的距离区间下，人们的生活行为往往会存在差异。因此发展了关于城市生活圈的研究，例如按照居民日常生活中各类活动发生的时间、空间以及功能特征，可以将居民的日常生活圈划分为五个等级层次，包括社会生活圈、基本生活圈、通勤生活圈、扩展生活圈以及都市区之间的协调生活圈*(柴彦威,张雪,孙道胜.基于时空间行为的城市生活圈规划研究——以北京市为例[J].城市规划学刊,2015(03):61-69.)*。在探索这些具有属性特征Nodes，基于 DBSCAN（Density-Based Spatial Clustering of Applications with Noise）聚类分析shi
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyODg4NzgxNSwtMTgzMTQ1MDgzNSwtMz
