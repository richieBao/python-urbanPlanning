...
### 2 数据 /data
数据使用OSM(open street map)提供的开源数据。OSM地图数据已经被广泛应用于制作地图以及相关研究，知名用户包括Facebook、Craigslist、Seznam、OsmAnd、Geocaching等，芝加哥部分的OSM数据内容满足本次研究的要求。




<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY3NDE4NDQ5OCwtNTEzNzA2MDg1LDk2MT
