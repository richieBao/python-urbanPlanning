...
## 《设计逻辑+算法+参数化》专著定位
基于上述粗略的综述内容，以及试图推动数字化设计的进一步发展，好的纯粹的工具教程类图书只能在参数化工具教学推广上促进数字化普及，而纯粹的理论研究因为缺失可操作性不易于数字化设计实践
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzU5MjAwNzQsMjA2MTY0MDA5NiwtMTE3OT
Y2NzE4NiwxMzAzNTE2MjU0LDE3ODkyOTQ2OSwtMTY1NjMxOTY3
MywxNDYyOTA2Mjc2LDczMDk5ODExNl19
-->