...
if __name__ == '__main__':
    ...
    polar_pts=polar_projection_dataset_skitti(in_dataset=dcp_dataset,grid_size=[100,100,36],rotate_aug=False,ignore_value=255,fixed_volume_space=False, max_volume_space=[25,np.pi,15], min_volume_space=[-25,-np.pi,-15])
    ...
    # processed_fp=r'E:\dataset\results\graph_dataset_batch'
