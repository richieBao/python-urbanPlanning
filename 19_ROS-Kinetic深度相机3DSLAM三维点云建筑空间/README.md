## 无人机航测正射影像
![](https://github.com/richieBao/python-urbanPlanning/blob/master/images/956.png)

## 基于VTK-python可视化点云数据
![](https://github.com/richieBao/python-urbanPlanning/blob/master/images/957.png)
```python
# -*- coding: utf-8 -*-
"""
...
```
## ROS核心图解
![](https://github.com/richieBao/python-urbanPlanning/blob/master/images/958.png)
